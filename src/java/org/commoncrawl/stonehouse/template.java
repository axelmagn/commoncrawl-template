...
/**
 * Template for Stonehouse Lock MapReduce objects.
 *
 * @author Axel Magnuson <axelmagn@commoncrawl.org>
 *
 * Based heavily on Examples by:
 *
 * Chris Stephens <chris@commoncrawl.org>
 */
public class Template extends Configured implements Tool {
  ...
  public static class TemplateMapper
      ...
      implements Mapper<Text, Text, Text, LongWritable> { // Change this line depending on input
    ...
    public void map(Text key, Text value, OutputCollector<Text, LongWritable> output, Reporter reporter)
      ...
      // Count how many records are processed
      ...
      try {
         ...
         * 
         *    // Increase a counter
         *    reporter.incrCounter(this._counterGroup, "MESSAGE" [, COUNT])
         *
         *    // Yield an output
         *    output.collect(KEY, VALUE)
         *
         *    // Log a message
         *    LOG.[error | warn | info]("MESSAGE" [, THROWABLE])
         *
         */ 
  ...
  public static class SampleFilter
    ...
    public boolean accept(Path path) {
      ...
      if (SampleFilter.count > SampleFilter.max && !infinite)
        return false;
